...
var cards = function () {
  ...
  Card.prototype = {
    init: function init(suit, rank, table) {
    ...
    moveTo: function moveTo(x, y, speed, callback) {
      var props = {
    ...
    rotate: function rotate(angle) {
      $(this.el).css('-webkit-transform', 'rotate(' + angle + 'deg)').css('-moz-transform', 'rotate(' + angle + 'deg)').css('-ms-transform', 'rotate(' + angle + 'deg)').css('transform', 'rotate(' + angle + 'deg)').css('-o-transform', 'rotate(' + angle + 'deg)');
    },
    ...
    hideCard: function hideCard(position) {
  ...
  Container.prototype.extend({
    ...
    click: function click(func, context) {
      this._click = {
        func: func,
        context: context
      };
    },
    mousedown: function mousedown(func, context) {
      this._mousedown = {
        func: func,
        context: context
      };
    },
    mouseup: function mouseup(func, context) {
      this._mouseup = {
        func: func,
        context: context
      };
  ...
  Deck.prototype.extend({
    calcPosition: function calcPosition(options) {
      options = options || {};
    ...
    deal: function deal(count, hands, speed, callback) {
      var me = this;
      var i = 0;
  ...
  Pile.prototype.extend({
    ...
    deal: function deal(count, hands) {
      if (!this.dealCounter) {
